...
import com.example.mybox.databinding.FragmentLabBinding
...
class LabFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
      ...
      /*  val piggies = listOf(
        ...
        piggies.add(Piggy(R.mipmap.icon_grid_color_helper,   "1"))
        piggies.add(Piggy(R.mipmap.icon_grid_device_helper,  "2"))
        piggies.add(Piggy(R.mipmap.icon_grid_drawable_helper, "3") )
        piggies.add(Piggy(R.mipmap.icon_grid_tip_dialog,     "4"))
        piggies.add(Piggy(R.mipmap.icon_grid_view_helper,    "5"))
        piggies.add(Piggy(R.mipmap.icon_grid_tip_dialog,    "6"))
        //创建适配器
