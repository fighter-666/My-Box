...
import com.example.mybox.databinding.AdapterRechargeContentAreaListBinding
...
class ContentAreaListAdapter(
    ...
    override fun convert(
        ...
        when (item.type) {
            ...
            "3" -> {
                ...
                if (item.price != null) {
                    ...
                    if (item.price.isOriginalPriceLine == "1") {
                        ...
                        binding.tvOriginalPrice.text = spannableString4
                    } else {
            ...
            //6：人数
            "6" -> {
                if (item.numText != null) {/*val priceInTenThousand = item.numText.toFloat() / 10000.0f
        ...
        binding.tvNumText.text = priceInTenThousand.toString()*/
            ...
            //9：末尾卡片按钮列表
            "9" -> {
                binding.tvNullTitleFirst.text = item.completionInfo.title
